...
export class UserService {
  ...
  getMyuser() {
    return this.http.get(this.baseUrl + '/api/users/myuser');
  }
  ...
  getMyProfilePicture() {
    return this.http.get(this.baseUrl + '/api/users/myuserprofileImage');
  }

  getTestPicture() {
    return this.http.get(this.baseUrl + '/api/JobOffer/getimagetest', {
      responseType: 'blob',
    });
  }

  getUserProfilePicture(data: any) {
    return this.http.post(this.baseUrl + '/api/users/userprofileImage', data);
  }

  updateMyUser(data: any) {
    var result = this.http.put(this.baseUrl + '/api/users/updatemyuser', data);
    return result;
  }

  testEncryption(data: any) {
    return this.http.post(this.baseUrl + '/api/users/profile/4', data);
  }

  getAll() {
    return this.http.get(this.baseUrl + '/api/users/allforadmin');
  }
